...
_NJEFC = flags.DEFINE_integer("nJefc", None, "Maximum number of non-zeros in constraint Jacobian.")
...
def _main(argv: Sequence[str]) -> None:
  ...
  if _ENGINE.value == EngineOptions.C:
    ...
    d = mjw.put_data(mjm, mjd, nconmax=_NCONMAX.value, njmax=_NJMAX.value, nJefc=_NJEFC.value, nccdmax=_NCCDMAX.value)
