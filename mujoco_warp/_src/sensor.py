...
def sensor_pos(m: Model, d: Data):
  ...
  wp.launch(_sensor_pos, dim=(m.nworld, m.sensor_pos_adr.size), inputs=[m, d])
...
def sensor_vel(m: Model, d: Data):
  ...
  wp.launch(_sensor_vel, dim=(m.nworld, m.sensor_vel_adr.size), inputs=[m, d])
...
def sensor_acc(m: Model, d: Data):
  ...
  wp.launch(_sensor_acc, dim=(m.nworld, m.sensor_acc_adr.size), inputs=[m, d])
