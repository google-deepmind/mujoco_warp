...
def put_model(mjm: mujoco.MjModel) -> types.Model:
  ...
  return types.Model(
    ...
    geom_priority=create_nmodel_batched_array(mjm.geom_priority, dtype=int),
    ...
    wrap_prm=create_nmodel_batched_array(mjm.wrap_prm, dtype=float),
    ...
    sensor_cutoff=create_nmodel_batched_array(mjm.sensor_cutoff, dtype=float),
