...
def make_data(mjm: mujoco.MjModel, nworld: int = 1, nconmax: int = -1, njmax: int = -1) -> types.Data:
  ...
  return types.Data(
    ...
    multiccd_polygon=wp.zeros(shape=(nconmax, 150), dtype=wp.vec3),
    multiccd_clipped=wp.zeros(shape=(nconmax, 150), dtype=wp.vec3),
    multiccd_pnormal=wp.zeros(shape=(nconmax, 150), dtype=wp.vec3),
    multicdd_pdist=wp.zeros(shape=(nconmax, 150), dtype=float),
    multicdd_idx1=wp.zeros(shape=(nconmax, 150), dtype=int),
    multicdd_idx2=wp.zeros(shape=(nconmax, 150), dtype=int),
    multicdd_n1=wp.zeros(shape=(nconmax, 150), dtype=wp.vec3),
    multicdd_n2=wp.zeros(shape=(nconmax, 150), dtype=wp.vec3),
    multicdd_endvert=wp.zeros(shape=(nconmax, 150), dtype=wp.vec3),
    multicdd_face1=wp.zeros(shape=(nconmax, 150), dtype=wp.vec3),
    multicdd_face2=wp.zeros(shape=(nconmax, 150), dtype=wp.vec3),
    # rne_postconstraint
