...
def _collide_geom_triangle(
  ...
  if gtype == int(GeomType.SPHERE):
    ...
    if dist < margin:
      _write_flex_contact(
          naconmax, dist, pos, make_frame(nrm), margin, condim, friction,
    ...
    if dists[0] < margin:
      ...
      _write_flex_contact(
          naconmax, dists[0], p1, make_frame(n1), margin, condim, friction,
          solref, solimp, geomid, flexid, vertex_id, worldid, contact_dist_out,
          contact_pos_out, contact_frame_out, contact_includemargin_out,
          contact_friction_out, contact_solref_out, contact_solreffriction_out,
          contact_solimp_out, contact_dim_out, contact_geom_out,
    ...
    if dists[1] < margin:
      ...
      _write_flex_contact(
          naconmax, dists[1], p2, make_frame(n2), margin, condim, friction,
          solref, solimp, geomid, flexid, vertex_id, worldid, contact_dist_out,
          contact_pos_out, contact_frame_out, contact_includemargin_out,
          contact_friction_out, contact_solref_out, contact_solreffriction_out,
          contact_solimp_out, contact_dim_out, contact_geom_out,
...
def _flex_narrowphase_dim2(
  ...
  t1 = flexvert_xpos[worldid, vert_adr + v0_local]
  t2 = flexvert_xpos[worldid, vert_adr + v1_local]
  t3 = flexvert_xpos[worldid, vert_adr + v2_local]
  ...
  for geomid in range(ngeom):
    ...
    geom_pos = geom_xpos[worldid, geomid]
    geom_rot = geom_xmat[worldid, geomid]
    ...
    _collide_geom_triangle(
        naconmax, gtype, geom_pos, geom_rot, geom_size_val, t1, t2, t3, tri_radius,
