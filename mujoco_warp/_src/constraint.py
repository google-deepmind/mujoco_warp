...
def _equality_connect(
  ...
  if is_sparse:
    ...
    rowadr0 = efcid0 * nefcdof_in
    rowadr1 = efcid1 * nefcdof_in
    rowadr2 = efcid2 * nefcdof_in
...
def _equality_tendon(
  ...
  for i in range(nv):
    ...
    if is_sparse:
      if J != 0.0:
        efc_J_colind_out[worldid, 0, rowadr + nnz] = i
...
def _equality_weld(
  ...
  if is_sparse:
    ...
    rowadr1 = efcid1 * nefcdof_in
    rowadr2 = efcid2 * nefcdof_in
    rowadr3 = efcid3 * nefcdof_in
    rowadr4 = efcid4 * nefcdof_in
    rowadr5 = efcid5 * nefcdof_in
  ...
  if active:
    ...
    if wrap_type[adr] == types.WrapType.JOINT:
      ...
      for i in range(ten_num):
        ...
        if is_sparse:
          if J != 0.0:
            efc_J_colind_out[worldid, 0, rowadr + nnz] = dofadr
            efc_J_out[worldid, 0, rowadr + nnz] = J
            nnz += 1
        else:
          efc_J_out[worldid, efcid, dofadr] = J
