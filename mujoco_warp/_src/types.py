...
class Model:
  ...
  Attributes:
    ...
    mesh_face: face indices for all meshes                   (*, nmeshface, 3)
  ...
  warp only fields:
    ...
    mesh_vertadr_offset: world offset for mesh vertex addresses
    mesh_graphadr_offset: world offset for mesh graph addresses
    mesh_polyadr_offset: world offset for mesh polygon addresses
    mesh_polyvertadr_offset: world offset for mesh polyvert addresses
    mesh_polymapadr_offset: world offset for mesh polymap addresses
  ...
  mesh_vertadr_offset: array("*", int)
  mesh_graphadr_offset: array("*", int)
  mesh_polyadr_offset: array("*", int)
  mesh_polyvertadr_offset: array("*", int)
  mesh_polymapadr_offset: array("*", int)
