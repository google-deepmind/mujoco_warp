...
class Data:
  ...
  Attributes:
    ...
    multicdd_idx1: list of normal index candidates for Geom 1   (nconmax, max_ndeg)
    multicdd_idx2: list of normal index candidates for Geom 2   (nconmax, max_ndeg)
    multicdd_n1: list of normal candidates for Geom 1           (nconmax, max_ndeg)
    multicdd_n2: list of normal candidates for Geom 1           (nconmax, max_ndeg)
    multicdd_endvert: list of edge vertices candidates          (nconmax, max_ndeg)
