...
class Model:
  ...
  Attributes:
    ...
    site_matid: material id for rendering                    (nworld, nsite,)
    site_group: group for visibility                         (nsite,)
    ...
    site_rgba: rgba when material is omitted                 (nworld, nsite, 4)
    ...
    flex_edge: edge vertex ids                               (nflexedge, 2)
    flex_edgeflap: adjacent vertex ids                       (nflexedge, 2)
    flex_elem: element vertex ids                            (nflexelemdata,)
...
warp only fields:
    ...
    block_dim: BlockDim settings for different tile operations
    ...
    taxel_vertadr: taxel vertex address                      (<=nsensor,)
    taxel_sensorid: taxel sensor id                          (<=nsensor,)
  """
