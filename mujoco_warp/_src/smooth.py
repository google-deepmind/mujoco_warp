...
def _flex_edges(
  ...
  # Edge jacobian
  for k in range(nv):
    jacp1, _ = support.jac(body_rootid, dof_affects_body, subtree_com_in, cdof_in, pos1, b1, k, worldid)
    jacp2, _ = support.jac(body_rootid, dof_affects_body, subtree_com_in, cdof_in, pos2, b2, k, worldid)
    jacdif = jacp2 - jacp1
