...
_NJEFC = flags.DEFINE_integer("nJefc", None, "override maximum number of non-zeros in constraint Jacobian")
...
def _main(argv: Sequence[str]):
  ...
  with wp.ScopedDevice(_DEVICE.value):
    ...
    d = mjw.put_data(
      mjm, mjd, nworld=_NWORLD.value, nconmax=_NCONMAX.value, njmax=_NJMAX.value, nJefc=_NJEFC.value, nccdmax=_NCCDMAX.value
    )
    rc = None
