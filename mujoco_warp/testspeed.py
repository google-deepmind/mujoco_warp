...
_NEFCDOF = flags.DEFINE_integer("nefcdof", None, "Maximum number of dofs per constraint.")
...
def _main(argv: Sequence[str]):
  ...
  with wp.ScopedDevice(_DEVICE.value):
    ...
    d = mjw.put_data(
      mjm, mjd, nworld=_NWORLD.value, nconmax=_NCONMAX.value, njmax=_NJMAX.value, nefcdof=_NEFCDOF.value, nccdmax=_NCCDMAX.value
    )
    rc = None
